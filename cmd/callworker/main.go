...
import (
	...
	callworker "github.com/acme/outbound-call-campaign/internal/worker/call"
...
func main() {
	...
	shutdown, err := telemetry.Setup(ctx, container.Config.Telemetry, container.Config.App.Name+"-call-worker")
	if err != nil {
	...
	worker := callworker.New(container)
